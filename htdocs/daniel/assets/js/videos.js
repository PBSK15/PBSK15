...
$(function(){
  ...
  *********************************************/
  ...
  var transitionTime     =   200;// 0.2 seconds
  var verticalPadding    =    70;// or whatever makes for you

  function scrollPlaylist(direction){
    direction = Math.min(1, Math.max(-1, direction || 1));//direction is either -1 or 1.
    var iscroll = playlist.iScroll;
    var x = 0;
    var y = 0;
    var bounds = {
      top   : iscroll.y,
      ...
      left  : iscroll.x,
      right : iscroll.x - iscroll.maxScrollX
    };
