...
PBS.KIDS.storybook.book = function (GLOBAL, PBS, storybookContainerElement, config, GAObj, preloader) {
    ...
    var sb = PBS.KIDS.storybook,
        ...
        loadingView,
        loadEvent,
        _preloader = preloader || sb.preloader(GLOBAL, PBS),
        ...
        leftPageSoundComplete = function () {
            ...
            if (rightPageIndex >= 0 && pages[rightPageIndex].pageSound) {
                pageSoundTimeout = setTimeout(function() 
                {
                    loud();
        ...
        updateLayout = function () {
            ...
            orientation = (storybookContainerElement.clientHeight > storybookContainerElement.clientWidth) ? "PORTRAIT" : "LANDSCAPE";
        ...
        updatePosition = function () {
            ...
            } else if (bookFormat === "ONE-PAGE") {
                bookContainerElement.className = "";
                // Center the book horizontally
                bookContainerElement.style.marginLeft = (containerWidth - pageElementWidth*3) / 2 + "px";
            }else {
                if (curOrientation === "PORTRAIT") {
        ...
        onNavigateComplete = function () {
            ...
            if (targetPageIndex === -1) {
                ...
                if ( pages[leftPageIndex].pageSound || pages[rightPageIndex].pageSound )
                    loud();
                else
                    silent();
                ...
                if (curOrientation === "PORTRAIT") {
                    ...
                    if (leftPageIndex === curPageIndex) {
                        if (pages[leftPageIndex].pageSound) {
                            ...
                            pageSoundTimeout = setTimeout(function() 
                            { 
                                audioPlayer.play(pages[leftPageIndex].pageSound, true)
                            }, 600);
                        }
                    // If the page is the right page
                        ...
                        if (pages[rightPageIndex].pageSound) {
                            ...
                            pageSoundTimeout = setTimeout(function() 
                            {
                                audioPlayer.play(pages[rightPageIndex].pageSound, true) 
                            }, 600);
                        }
                    }
                // if two-page layout
            ...
            if (targetPageIndex === -1) {
                ...
                if (curOrientation === "PORTRAIT") {
                    ...
                    if (nextPageButtonElement) {
                        ...
                        document.body.className = document.body.className.replace(" on-last-page", "");
                        
                        if (targetPageIndex === pages.length -1) {
                            document.body.className += ' on-last-page';
                        }
                    }
                } else {
                    if (prevPageButtonElement) {
                    ...
                    if (nextPageButtonElement) {
                        ...
                        if (rightPageIndex === pages.length -1) {
                            document.body.className += ' on-last-page';
                        }
                    }
                }
            ...
            if(tracker) {
                if(bookFormat === "TWO-PAGE") {
                    tracker.trackEvent("Page"+(curPageIndex+1), "Page_View");
                    if(curPageIndex > -1) {
                        tracker.trackEvent("Page"+(curPageIndex+2), "Page_View");
                    }
                }else {
                    if(curPageIndex > -1) {
                        tracker.trackEvent("Page"+(curPageIndex/2+1), "Page_View");
                    }else {
                        tracker.trackEvent("Page"+(curPageIndex+1), "Page_View");
                    }
                }
            ...
            that.dispatchEvent("PAGE_CHANGE", curPageIndex);
        ...
        onNavigateMiddle = function () {
            ...
            if (targetPageIndex > curPageIndex) {
                ...
                if (curPageIndex === -1) {
                    ...
                    pageTurnContainerElement.style.marginLeft = bookFormat === "TWO-PAGE" ? -pageElementWidth / 2 + "px" : -pageElementWidth + "px";
                } else {
                    // Position the turning page
        ...
        navigateToPageIndex = function (pageIndex, doNotAnimate) {
            ...
            // var turnOffPageButtons = function() {
            ...
            // var choice1made = PBS.KIDS.storybook.choices.optionSelected(1);
            // var choice2made = PBS.KIDS.storybook.choices.optionSelected(2);
            // var choice3made = PBS.KIDS.storybook.choices.optionSelected(3);

            // var navigatingTo = pageIndex + 1;

            // if(navigatingTo === 3 && !choice1made) {
            //     return;
            // }
            // if(navigatingTo === 5 && !choice2made) {
            //     return;
            // }
            // if(navigatingTo === 7 && !choice3made) {
            //     return;
            // }
            ...
            if (doNotAnimate) {
                ...
                // If turning forward
                if (targetPageIndex > curPageIndex) {
                    // If in landscape layout or in portrait layout and is the right page
                    if (curOrientation === "LANDSCAPE" || curPageIndex % 2) {
                        ...
                        if (curPageIndex === -1) {
                            ...
                            if(bookFormat === "TWO-PAGE") {
                                ...
                                pageTurnContainerElement.style.marginLeft = 0 + "px";
                            }
                        ...
                        GLOBAL.setTimeout(updatePosition2, pageTurnDuration);
        ...
        start = function () {
            ...
            if (prevPageButtonSprite) {
                ...
                prevPageButtonSprite.addEventListener("RELEASE", that.previousPage);
            }
            ...
            if (nextPageButtonSprite) {
                ...
                nextPageButtonSprite.addEventListener("RELEASE", that.nextPage);
            }
        ...
        updateLoadMessage = function (e) {
            ...
            _preloader.updateProgress(loadEvent);
        },
        ...
        checkLoadComplete = function() {
            if (resourceLoadComplete && (!audioPlayer || audioLoadedEnough === true)) {
                start();
            }
        },
        ...
        loadAudio = function () {
            ...
            _preloader.showProgress();

            audioLoadInitiated = true;
            audioPlayer.addEventListener("LOAD_COMPLETE", audioLoaded);
            audioPlayer.load();
        },
        ...
        init = function () {
            ...
            var i, p, pageContainerElement, audioFilename;
            
            if (!initialized) {
            
                initialized = true;

                bookFormat = config.book.singlePageFormat === true ? "ONE-PAGE" : "TWO-PAGE";
                storybookContainerElement.className = config.book.singlePageFormat === true ? "one-page" : "two-page";

                tracker = sb.tracker(GLOBAL, PBS, GAObj, config.analytics || {});
                ...
                if (config.audio && config.audio && config.audio.name && config.audio.enabled !== false && createjs.Sound.initializeDefaultPlugins()) {
                    createjs.Sound.alternateExtensions = ["ogg"];
                    var isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
                    audioPlayer = sb.audioPlayer(GLOBAL, PBS, config.audio.path + config.audio.name + (isMobile ? '-mobile' : ''));
                }
                ...
                for (i = 0, p = 0; i < config.pages.length; i++) {
                    if(bookFormat === "ONE-PAGE") {
                        pages[p] = sb.page(GLOBAL, PBS, config.book.blankPageFormat, p + 1, { bookConfig: bookConfig, audioPlayer: audioPlayer, tracker: tracker }, that);
                        pages[p].update();
                        pages[p].render();
                        p++;
                    }

                    pages[p] = sb.page(GLOBAL, PBS, config.pages[i], p + 1, { bookConfig: bookConfig, audioPlayer: audioPlayer, tracker: tracker }, that);
                    pages[p].update();
                    pages[p].render();
                    p++;
                }
                ...
                if (bookFormat === "TWO-PAGE" && config.pages.length % 2) {
                    pages[pages.length] = sb.page(GLOBAL, PBS, {}, config.pages.length + 1, {
                        bookConfig: bookConfig,
                        audioPlayer: audioPlayer
                    }, that);
                }
                ...
                storybookContainerElement.addEventListener('click', function()
                {
                    setTimeout(function() 
                    {
                        if ( curPageIndex == -1 && !audioPlayer.isPlaying() )
                            that.nextPage();
    ...
    that.getContent = function (pageNumber, contentIndex) {
        // return sprite
        return pages[pageNumber] ? pages[pageNumber].getContent(contentIndex) : null;
    };

    that.getDrawingPad  = function (pageNumber, padIndex) {
        return pages[pageNumber].getDrawingPad(padIndex);
    };
    ...
    that.previousPage = function () {
        ...
        if (targetPageIndex === -1) {
            ...
            document.body.className += ' to-cover';
        }
    };
    ...
    that.playSound = function(soundObj) {
        audioPlayer.play(soundObj);
    };
    ...
    that.load = function () {
        ...
        if (!loadStarted) {
            ...
            loadingContainerElement = _preloader.createElementIn(storybookContainerElement);
        ...
        //     var readyToStart = GLOBAL.document.createElement("div");
        //     readyToStart.className = "readyToStart";
        //     loadingContainerElement.appendChild(readyToStart);
