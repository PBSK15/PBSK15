...
swfobject.embedSWF_PBS_enable_cdn = function(swfUrl,id,width,height,version,expressInstallSwfurl, flashvars,params,attributes) {
    if(!params)  {
        params = {};
     }
     params.base = PBS_get_mirror_base();
     
     swfUrl = PBS_get_mirror_url(swfUrl);
     
     this.embedSWF(swfUrl,id,width,height,version,expressInstallSwfurl, flashvars,params,attributes);
