...
==================
  ...
  * QUnit: testrunner.js: Ensures equality of types (String, Boolean, Number) declared with the 'new' prefix. See comments #3, #4 and #5 on https://philrathe.com/articles/equiv
  ...
  * QUnit: update equiv to latest version, handling multiple arguments and NaN, see https://philrathe.com/articles/equiv
  ...
  * qunit: added id/classes to result element to enable integration with browser automation tools, see https://docs.jquery.com/QUnit#Integration_into_Browser_Automation_Tools
  ...
  * qunit: moved jquery testrunner to top-level project, see https://docs.jquery.com/QUnit
