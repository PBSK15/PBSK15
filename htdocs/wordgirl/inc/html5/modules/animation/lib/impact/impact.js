...
window.ig = {
	...
	_boot: function() {
		...
		ig.ua.IE9 = /MSIE 9.0/i.test(navigator.userAgent);
		...
		ig.ua.androidDevice = ig.ua.android || ig.ua.kindle || ig.ua.winPhone;
		ig.ua.mobile = ig.ua.iOS || ig.ua.android || ig.ua.winPhone || ig.ua.kindle;
...
// https://ejohn.org/blog/simple-javascript-inheritance/
