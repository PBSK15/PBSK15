...
ig.Input = ig.Class.extend({
	...
	initPage: function () {
		if (!this.isUsingPage) this.isUsingPage = true, window.addEventListener("pageshow", this.pageshow.bind(this), false), window.addEventListener("pagehide", this.pagehide.bind(this), false);
	},
	pagehide: function () {
		ig.game.hidePage();
	},
